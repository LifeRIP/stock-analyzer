  ...
  <nav class="bg-white shadow-md">
      ...
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden md:block">
          <div class="flex items-center space-x-4">
            ...
            <router-link to="/recommendations" class="px-3 py-2 rounded-md text-sm font-medium hover:bg-gray-100">
              Recommendations
            </router-link>
            <button 
              @click="syncStocks" 
    ...
    <div v-if="isMobileMenuOpen" class="md:hidden">
      <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
        <router-link to="/" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100" @click="isMobileMenuOpen = false">
          Stocks
        </router-link>
        <router-link to="/recommendations" class="block px-3 py-2 rounded-md text-base font-medium hover:bg-gray-100" @click="isMobileMenuOpen = false">
          Recommendations
        </router-link>
        <button 
...
import { ref } from 'vue'
// Actualizar la importación del store
